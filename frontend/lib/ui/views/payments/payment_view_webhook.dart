...
import 'package:good_wallet/ui/views/payments/payment_sheet_viewModel.dart';
import 'package:good_wallet/ui/widgets/buttons/loading_buttons.dart';
import 'package:stacked/stacked.dart';

class PaymentViewWebhook extends StatefulWidget {
  @override
  _PaymentViewWebhookState createState() => _PaymentViewWebhookState();
}

class _PaymentViewWebhookState extends State<PaymentViewWebhook> {
  ...
  Future<Map<String, dynamic>> fetchPaymentIntentClientSecret() async {
    final url =
        Uri.parse('${StripeService.paymentApiUri}/create-payment-intent');
